...
public interface InterviewResultMapper
{
	 ...
	 * @param retirementYn 재직/퇴직여부
	 * @param userNm 사용자명
	 * @param heaCheckedOrgNos 검진기관
	 * @param smokingCd 흡연여부
	 * @param drinkingCd 음주여부
	 * @return 문진결과 목록
	 * @throws Exception
	 */
	public List<InterviewResult> getInterviewResults(
			...
			@Param("smokingCd") String smokingCd,
			@Param("drinkingCd") String drinkingCd) throws Exception;
	 ...
	 * @throws Exception
	 */
	public int deleteInterviewResult(
			@Param("heaCheckupPlanNo") int heaCheckupPlanNo,
