...
public class MssqlDBConfig {
     ...
     * Thead Safe하게 작성되었기 때문에 여러 매퍼에서 공유
     */
    @Primary
    @Bean(name = "mssqlSqlSessionFactory")
    ...
    @Primary
    public DataSourceTransactionManager transactionManager(@Qualifier("mssqlDataSource")DataSource dataSource) throws Exception
    {
